...
-(void)editFun{
    ...
    if ([task.state  isEqual: @"in progress"]){
       [_editTaskInProgressDelegateRef editTaskInProgress:dict:_CellInedex];
    }else if ([task.state  isEqual: @"done"]){
       [_editTaskInProgressDelegateRef editTaskDone :dict:_CellInedex];
    }
